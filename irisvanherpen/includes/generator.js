...
$(document).ready(function(){
	...
	// var contures=['../photos/aeriform1_thumbnail.jpg','../photos/aeriform2_thumbnail.jpg','../photos/aeriform3_thumbnail.jpg', '../photos/aeriform4_thumbnail.jpg'];
	// var contureImg=choice(contures);
	// $(#aeriform).attr('src',contureImg);
...
function checkViewport(){
	...
	var thumbnailWidth=$('.thumbnail_container a.thumbnail:firstchild').outerWidth();
